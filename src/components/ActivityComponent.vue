<template>
  ...
  >
    <Modal :modal-type="selectedActivity" @close-modal="toggleModal" @delete="deleteActivity" />
  </section>
  <section
  ...
  methods: {
    ...
    async deleteActivity(activity) {
      if (this.isModalOpen) {
        ...
        this.selectedActivity = {id: activity.id, type: 'activity', title: activity.title}
